...
{
   Circle circle2 = new Circle2(0,0,5);
   Circle circle3 = new Circle2(1,0,5);
...
{
   Circle circle2 = new Circle2(10,0,5);
   Circle circle3 = new Circle2(0,0,5);
...
{
   Circle circle2 = new Circle2(0,1,5);
   Circle circle3 = new Circle2(0,0,5);
...
{
   Circle circle2 = new Circle2(0,10,5);
   Circle circle3 = new Circle2(0,0,5);
...
{
   Circle circle2 = new Circle2(1,1,5);
   Circle circle3 = new Circle2(3,3,5);
...
{
   Circle circle2 = new Circle2(0,0,5);
   Circle circle3 = new Circle2(10,10,5);
...
{
   Circle circle2 = new Circle2(0,3,2);
   Circle circle3 = new Circle2(20,30,12);
...
public void initCirclePos()
{
   ...
   int y = 2;
   double radius = 3;
   Circle circle2 = new Circle2(x,y,radius);
